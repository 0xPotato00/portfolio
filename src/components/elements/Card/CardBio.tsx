...
const CardBio: FC<CardBioProps> = ({ bio, title }) => {
  return (
    <div class="nm-flat-gray-200-lg rounded-lg p-8 text-center max-w-sm w-full">
      <h2 class="text-2xl font-bold leading-tight mb-4">{title}</h2>
      <p>
      ...
      <a
        href="#"
        class="rounded-full bg-green-500 shadow-gray-200 leading-5 px-8 py-4 uppercase font-bold tracking-widest text-white inline-block mt-4"
      >
        Find out more
      </a>
    </div>
